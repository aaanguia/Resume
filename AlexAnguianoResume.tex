...
\section{\faFlask}{Projects}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \resumeItem {Utilized Java Swing, JSON manipulation, and JUnit to create a log in function used to populate the UI according to the permissions assigned to the current user. }
  ...
  \resumeEntryEnd
    ...
    \resumeItemListStart
      \resumeItem {Software Enterprise project to assess developer's ability to follow requirements while utilizing Design Patterns.}
...
\section{\faGears}{Skills}
 \resumeEntryStart
  ...
  \resumeEntryS{Technologies } {Java, HTML, CSS, JavaScript, C, JSON,  Windows, Linux, macOS, MS Office Suite, Agile}
 \resumeEntryEnd
